#
# bmlab documentation build configuration file, created by
...
rst_prolog = """
:github_url: https://github.com/BrillouinMicroscopy/bmlab
"""
...
copyright = '2022, bmlab developers'
...
html_logo = "logo/bmlab_large_white.png"
html_theme_options = {
    'logo_only': True,
}
...
latex_documents = [
    (master_doc, 'bmlab.tex', 'bmlab Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'bmlab', 'bmlab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bmlab', 'bmlab Documentation',
     author, 'bmlab', 'post-measurement analysis of Brillouin microscopy data',
     'Scientific'),
]
